    ...
    <div className="bg-qz-gray200 p-4 text-gray-800">
      ...
      <div className="mt-4 flex justify-between gap-4">
        {modes.map(({ t, i }) => {
          return (
            <div
              className="flex w-full justify-start gap-[0.8rem] overflow-clip text-nowrap rounded-md bg-white px-4 py-[0.8rem] font-semibold shadow-md"
              key={t}
            >
              {i}
              {t}
      ...
      <div className="mt-6">
        <div
          className="relative flex h-[428px] flex-col bg-white shadow-md"
          onClick={flip}
        >
          {/* card controls */}
